...
Для одновременной работы нескольких аккаунтов откройте **Система → Параллельные аккаунты**, выберите **Новый экземпляр** и нажмите **Открыть выбранный**. Каждый экземпляр использует свой порт, сессию и настройки. Повторите действие для других аккаунтов. Чтобы остановить один экземпляр, используйте **Система → Остановить и выйти** в его окне.
...
- Для отдельной сессии можно запустить `start-ui.bat --port 4312` и открыть <http://127.0.0.1:4312>.
